...
public sealed class MySqlServerVersionTests
{
  ...
  {
    MySqlServerVersion version = MySqlConnection.ParseServerVersion("8.4.2");
  ...
  {
    MySqlServerVersion version = MySqlConnection.ParseServerVersion("8.0.36-log");
  ...
  public void StripsMariaDbCompatibilityPrefix()
  {
    ...
    MySqlServerVersion version = MySqlConnection.ParseServerVersion("5.5.5-11.8.2-MariaDB");
  ...
  {
    MySqlServerVersion version = MySqlConnection.ParseServerVersion("10.11.6-MariaDB");
  ...
  {
    MySqlServerVersion version = MySqlConnection.ParseServerVersion("9");
  ...
  {
    MySqlServerVersion version = MySqlConnection.ParseServerVersion("unknown-server");
