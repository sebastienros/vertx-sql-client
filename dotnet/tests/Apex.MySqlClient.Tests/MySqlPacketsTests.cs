...
public sealed class MySqlPacketsTests
{
  ...
  public void IsEofUsesDeprecateEofLengthRule()
  {
    ...
    byte[] longOkLike = new byte[MySqlProtocol.MaximumFramePayloadLength];
    longOkLike[0] = 0xFE;
  ...
  public void ReadsOkPacketWithProtocol41Fields()
  {
    ...
    MySqlCompletion completion = MySqlPackets.ReadOk(payload, MySqlCapabilities.Protocol41);
  ...
  public void ReadsOkPacketWithOnlyTransactionsCapability()
  {
    ...
    MySqlCompletion completion = MySqlPackets.ReadOk(payload, MySqlCapabilities.Transactions);
  ...
  public void ReadsOkPacketWithoutStatusCapabilities()
  {
    ...
    MySqlCompletion completion = MySqlPackets.ReadOk(payload, MySqlCapabilities.None);
  ...
  public void ReadsEofPacketWithProtocol41Fields()
  {
    ...
    MySqlCompletion completion = MySqlPackets.ReadEof(payload, MySqlCapabilities.Protocol41);
  ...
  public void ReadsEofPacketWithoutProtocol41Capability()
  {
    ...
    MySqlCompletion completion = MySqlPackets.ReadEof(payload, MySqlCapabilities.None);
  ...
  public void ReadsErrorPacketWithSqlState()
  {
    ...
    MySqlException exception = MySqlPackets.ReadError(payload);
