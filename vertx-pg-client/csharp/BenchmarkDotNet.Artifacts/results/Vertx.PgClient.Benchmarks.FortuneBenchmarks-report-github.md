...
|--------------------------------------- |----------- |--------------- |------------ |---------:|---------:|--------:|----------:|
| &#39;SELECT all fortunes (prepared query)&#39; | Job-YFEFPZ | 10             | Default     | 226.9 μs |  1.81 μs | 1.20 μs |    7.9 KB |
| &#39;SELECT all fortunes (prepared query)&#39; | ShortRun   | 3              | 1           | 226.1 μs | 20.64 μs | 1.13 μs |    7.9 KB |
